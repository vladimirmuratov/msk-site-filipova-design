...
export const gastroenterologyImages = [
    {id: 1, src: '/images/gastroenterology/1.webp', alt: 'платный стационар гастроэнтерология', title: 'платная гастроэнтерология в москве'},
    {id: 2, src: '/images/gastroenterology/2.webp', alt: 'платная госпитализация в москве гастроэнтерология', title: 'платные палаты в больнице'},
]

export const therapyImages = [
    {id: 1, src: '/images/therapy/1.webp', alt: 'госпитализация в терапию', title: 'палата полулюск'},
    {id: 2, src: '/images/therapy/2.webp', alt: 'платный стационар терапия', title: 'туалетная комната'},
    {id: 3, src: '/images/therapy/3.webp', alt: 'больница терапия платная палата', title: 'одноместная палата'},
    {id: 4, src: '/images/therapy/4.webp', alt: 'госпитализация в терапию москва', title: 'одноместная палата'},
]
