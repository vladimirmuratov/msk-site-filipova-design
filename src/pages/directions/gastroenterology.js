...
export default function Gastroenterology() {
    return (
        <>
            <Head>
                <title>Платная гастроэнтерология в москве. Платные госпитализации 8 (499) 719-81-00, 24/7</title>
                <meta name="description"
                      content="Платная гастроэнтерология в москве. Платные госпитализации 8 (499) 719-81-00, 24/7, платная больница гастроэнтерология  платный стационар гастроэнтерология платная госпитализация в москве гастроэнтерология платные палаты в больнице" />
                <meta name="keywords"
            ...
            <Box>
                ...
                <BaseBanner imgPath="/images/directions/7.webp" title="платная гастроэнтерология в москве" />
                ...
                >
                    <BaseText>
                        ...
                        желудочно-кишечных заболеваний, включая инфекции (особенно хеликобактерные), патологии печени
                        желчевыводящих путей всех этиологий, поражения поджелудночной железы и кишечника.
                    </BaseText>
                    <Typography
                        component="h2"
                        sx={{
                    ...
                    >&nbsp;Платная госпитализация в москве гастроэнтерология.</Typography>
                    ...
                    >
                        ...
                        <List>
                            ...
                            <ListItem sx={{ gap: '10px' }}>
                                ...
                                <ListItemText>
                                    <BaseText>
                                        Определение липидового профиля, показателей иммунитета
                                    </BaseText>
                                </ListItemText>
                            </ListItem>
                            <ListItem sx={{ gap: '10px' }}>
                            ...
                            <ListItem sx={{ gap: '10px' }}>
                                ...
                                <ListItemText>
                                    <BaseText>
                                        Эндоскопические исследования ЖКТ (включая ФГДС)
                                    </BaseText>
                                </ListItemText>
                            </ListItem>
                            <ListItem sx={{ gap: '10px' }}>
                            ...
                            <ListItem sx={{ gap: '10px' }}>
                                ...
                                <ListItemText>
                                    <BaseText>
                                        Ультразвуковые методы, радиоизотопная диагностика
                                    </BaseText>
                                </ListItemText>
                            </ListItem>
                            <ListItem sx={{ gap: '10px' }}>
                                ...
                                <ListItemText>
                                    <BaseText>
                                        Магнитно-резонансное сканирование брюшной полости
                                    </BaseText>
                                </ListItemText>
                            </ListItem>
                            <ListItem sx={{ gap: '10px' }}>
                                ...
                                <ListItemText>
                                    <BaseText>
                                        ...
                                        подтверждение
                                        хеликобактероза и вирусного гепатита
                                    </BaseText>
                                </ListItemText>
                            </ListItem>
                        </List>
                    ...
                    >
                        ...
                        <List>
                            <ListItem sx={{ gap: '10px' }}>
                                ...
                                <ListItemText>
                                    <BaseText>
                                        Передовые схемы эрадикации H. pylori
                                    </BaseText>
                                </ListItemText>
                            </ListItem>
                            <ListItem sx={{ gap: '10px' }}>
                    ...
                    <BaseText>
                        Коллектив состоит из высококлассных гастроэнтерологов, терапевтов с внимательным подходом к
                        пациентам,
                        создающим атмосферу заботы и профессионализма по стандартам лучших медицинских учреждений
                        страны.
                    </BaseText>
