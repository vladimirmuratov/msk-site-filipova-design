...
export default function Robot() {
    ...
    return (
        <>
            <Head>
                <title>
                    Медицинская Сервисная Компания. Роботизированное эндопротезирование суставов в Москве — госпитализация. 8 (499) 719-81-00, 24/7
                </title>
                <meta
                    name="description"
            ...
            <Box>
                ...
                <BaseBanner imgPath="/images/endoprosthetics/7.webp"
                    ...
                    <BaseText>
                        <span
                            style={{
                                fontWeight: 600,
                                color: 'var(--red)'
                            }}>Роботизированное эндопротезирование </span> — это высокотехнологичная операция по замене
