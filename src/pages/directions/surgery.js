...
export default function Surgery() {
    ...
    return (
      <>
        <Head>
          <title>Платная хирургия в Москве — операции и госпитализация</title>
          <meta
            name="description"
            content="Хирургическое лечение по всем направлениям: абдоминальная, сосудистая, травматология и другие. Организация госпитализации в клиники Москвы без очередей."
          />
          <meta
            name="keywords"
