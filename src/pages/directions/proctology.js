...
export default function Proctology() {
    ...
    return (
      <>
        <Head>
          <title>Платная госпитализация в проктологии Москвы</title>
          <meta
            name="description"
            content="Платная госпитализация в ведущие колопроктологические центры Москвы. Лечение геморроя, трещин, свищей, полипов, колита, болезни Крона. Индивидуальный подбор клиники и врача."
          />
          <meta
            name="keywords"
