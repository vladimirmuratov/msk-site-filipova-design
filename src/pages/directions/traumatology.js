...
export default function Traumatology() {
    ...
    return (
      <>
        <Head>
          <title>Травматология и ортопедия в Москве — госпитализация</title>
          <meta
            name="description"
            content="Комплексное лечение травм, переломов, артрозов и заболеваний суставов. Платная госпитализация в клиники Москвы без ожидания, подбор специалистов."
          />
          <meta
            name="keywords"
