      ...
      <>
        ...
        >
          ...
          <Link href={`tel:${phone2}`}>
            ...
            >
              <span style={{ color: 'var(--blue)', fontWeight: 500, visibility: 'hidden' }}>
                телефон:{' '}
              </span>
              {phone2}
            </Typography>
          ...
          <Typography>
            <span style={{ color: 'var(--blue)', fontWeight: 500 }}>ИНН:</span> 9727115000
          </Typography>
          <Typography>
            <span style={{ color: 'var(--blue)', fontWeight: 500 }}>КПП:</span> 772701001
          </Typography>
          <Typography>
            <span style={{ color: 'var(--blue)', fontWeight: 500 }}>ОГРН:</span> 1257700446321
          </Typography>
        </Box>
      </>
    );
