...
export default function Transfer() {
    ...
    return (
      <>
        <Head>
          <title>
            Перевод пациента в другую больницу в Москве | Межбольничная транспортировка 24/7,
            реанимобили
          </title>
          <meta
            name="description"
            content="Круглосуточная организация перевода пациентов в другую больницу Москвы и области. Реанимобили и санитарный транспорт, сопровождение врача "
          />
          <meta
            name="keywords"
          ...
          <meta
            property="og:url"
            content="https://msk-group-hospital.vercel.app/services/transfer"
          />
          <meta
            property="og:image"
