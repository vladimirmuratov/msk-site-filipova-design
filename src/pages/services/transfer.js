...
export default function Transfer() {
  return (
    <>
      <Head>
        <title>Перевод пациента в другую больницу. Звоните: 8 (499) 719-81-00, 24/7</title>
        <meta
          name="description"
          content="Перевод в другую больницу? Мы здесь, чтобы помочь! Звоните круглосуточно: 8 (499) 719-81-00"
        />
        <meta
          name="keywords"
