...
export default function Emergency() {
    ...
    return (
      <>
        <Head>
          <title>Экстренная госпитализация в Москве 24/7 | Срочная помощь, вызов скорой</title>
          <meta
            name="description"
            content="Круглосуточная экстренная госпитализация в Москве. Быстрая транспортировка, госпитализация при инсульте, инфаркте, травмах, остром животе. Работаем 24/7, без выходных. Звоните!"
          />
          ...
          <meta
            property="og:title"
            content="Экстренная госпитализация в Москве 8 (499) 719-81-00, 24/7"
          />
          <meta
          ...
          <meta
            property="og:url"
            content="https://msk-group-hospital.vercel.app/services/emergency"
          />
          <meta
            property="og:image"
        ...
        />
        <HowToBeHospitalized
          title="что делать при экстренной ситуации"
