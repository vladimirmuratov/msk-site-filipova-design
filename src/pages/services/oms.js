...
export default function Oms() {
    ...
    return (
      <>
        <Head>
          <title>
            Госпитализация без полиса ОМС в Москве 24/7 | Экстренная помощь без страховки
          </title>
          <meta
            name="description"
            content="Круглосуточная госпитализация пациентов без полиса ОМС в Москве. Экстренная и плановая помощь, лечение иностранцев и лиц без гражданства. Быстрая транспортировка, оплата по факту. Звоните 24/7!"
          />
          <meta
            name="keywords"
