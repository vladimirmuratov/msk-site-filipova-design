...
export default function Oms() {
  return (
    <>
      <Head>
        <title>Госпитализация без полиса ОМС. Звоните: 8 (499) 719-81-00, 24/7</title>
        <meta
          name="description"
          content="Платная госпитализация без полиса ОМС - это просто! Получите доступ к лучшим врачам и современным методам лечения. Свяжитесь с нами! 8 (499) 719-81-00, 24/7."
        />
        <meta
          name="keywords"
