...
export default function PlanHospital() {
    ...
    return (
      <>
        <Head>
          <title>
            Платная плановая госпитализация в Москве | Госпитализация без очереди, комфортные
            палаты
          </title>
          <meta
            name="description"
            content="Организация платной плановой госпитализации в ведущих клиниках Москвы. Гарантированные сроки, отсутствие очередей, комфортабельные палаты, выбор врача. Хирургия, онкология, кардиология, травматология. Прозрачные цены 'под ключ'. Запись онлайн и по телефону!"
          />
          <meta
            name="keywords"
          ...
          <meta
            property="og:url"
            content="https://msk-group-hospital.vercel.app/services/plan-hospital"
          />
          <meta
            property="og:image"
