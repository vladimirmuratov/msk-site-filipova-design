...
import { CarouselForBanners } from '@/components/CarouselForBanners';
import { bannerImages } from '@/config/banner-images';
    ...
    <>
      {typeof isMobile === 'boolean' ? (
        <main className={openSans.className}>
          ...
          {/*<Banner4 />*/}
          <CarouselForBanners images={bannerImages} />
          <BaseCallBlock text="Ответим на любые вопросы по госпитализации и лечению. Звоните!" />
          <DescriptionBlockVer2 />
          <WhyWeBlockVer2 />
          <FearBlock />
          <HowToBeHospitalized steps={stepsPlanHospitalization} title="как это работает" />
          <BaseCallBlock
